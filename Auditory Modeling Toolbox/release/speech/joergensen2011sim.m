function [dSRT] = joergensen2011sim(NSpeechsamples,varargin)
% JOERGENSEN2011SIM Simulate the experiments shown in figure 5 and 6 of Jørgensen and Dau (2011)
%   Usage: [dSRT]  = joergensen2011simFig6(NSpeechsamples,varargin)
%
%   Output parameters:
...
%     
%
%   Url: http://amtoolbox.sourceforge.net/doc/speech/joergensen2011sim.php
