function [azEst,gridAz] = may2011estAzimuth_GMM(AZ_MODULE,intLL,nSources,bPlot)
...
%
%   Url: http://amtoolbox.sourceforge.net/doc/modelstages/may2011estAzimuth_GMM.php
...
pIdx = may2011findLocalPeaks([0; xcorr_ALL(:); 0]);
pIdx = pIdx - 1;
...
delta = may2011interpolateParabolic(xcorr_ALL,pIdx(idx(1:nEst)));
...
if bPlot || nargout == 0
    ...
    mDelta   = may2011interpolateParabolic(xcorr_Freq,mIdxPlot); 
