function out = may2011frameData(input,blockSize,hopSize,win)
...
% 
%
%   Url: http://amtoolbox.sourceforge.net/doc/modelstages/may2011frameData.php
...
out = comp_may2011frameData(input,blockSize,hopSize,win,nFrames);
