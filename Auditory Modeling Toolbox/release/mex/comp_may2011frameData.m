function varargout = comp_may2011frameData(varargin)
...
%
%   Url: http://amtoolbox.sourceforge.net/doc/mex/comp_may2011frameData.php
...
error(['MEX function "',mfilename,'" is not available for your ',...
       'operating system (',computer,'). Run "AMTMEX" to built ',...
