function        [a_post_snr_bias,a_priori_snr_bias]=estimate_snrs_bias(noisy_dft_frame_p,fft_size ,noise_psd, SNR_LOW_LIM,  ALPHA  ,I,clean_est_dft_frame_p)   ;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%
 a_post_snr_bias =  noisy_dft_frame_p./(noise_psd(1:fft_size/2+1));%a posteriori SNR
if I==1,
    ...
    %       =========================
       a_priori_snr_bias=max(ALPHA*( clean_est_dft_frame_p(1:fft_size/2+1))./(   noise_psd(1:fft_size/2+1))+(1-ALPHA)*(a_post_snr_bias-1),SNR_LOW_LIM);
end